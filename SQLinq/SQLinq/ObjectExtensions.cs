...
namespace SQLinq
{
    public static class ObjectExtensions
    {
        ...
        public static SQLinqInsert<T> ToSQLinqInsert<T>(this T obj, string tableName = null)
        {
            return SQLinq.Insert(obj, tableName);
        }

        public static SQLinqUpdate<T> ToSQLinqUpdate<T>(this T obj, string tableName = null)
        {
            return SQLinq.Update(obj, tableName);
        }
    }
}
